...
public class HereMapsClient {
    ...
    public static Response GetRoute(double vanLat, double vanLng, double totLat, double totLng, boolean includeTraffic) throws IOException {
        ...
        String mode = "fastest;car;traffic:enabled";
