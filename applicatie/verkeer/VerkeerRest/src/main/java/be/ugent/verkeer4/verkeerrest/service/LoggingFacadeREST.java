...
import be.ugent.verkeer4.verkeerrest.Logging;
 ...
 */
@Stateless
@Path("be.ugent.verkeer4.verkeerrest.logging")
public class LoggingFacadeREST extends AbstractFacade<Logging> {
    ...
    @Path("{id}")
    @Consumes({MediaType.APPLICATION_XML, MediaType.APPLICATION_JSON})
    public void edit(@PathParam("id") Integer id, Logging entity) {
        super.edit(entity);
    }
    ...
    public Logging find(@PathParam("id") Integer id) {
